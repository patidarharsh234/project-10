...
/**
 * User POJO class. It is persistent object. Author @authorHarsh Patidar
 */
...
public class UserDTO extends BaseDTO {
	...
	// label mesage ke sat name lejata
	// kis liye to jis bhi nuse kes ke dto se aayega uski filed ka name le kr aayega
	// or
	// bolega name is allready exesist
	@Override

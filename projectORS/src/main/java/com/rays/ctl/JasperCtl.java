...
//	  @Autowired 
	...
	//	Set<String> path =context.getResourcePaths("C:\\JASPER_REPORT\\meanMeritMarksheet.jrxml") ;
	//	System.out.println("path************----"+path);
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("C:\\JASPER_REPORT\\meanMeritMarksheet.jrxml");

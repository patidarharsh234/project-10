...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _auth_service__WEBPACK_IMPORTED_MODULE_44__["AuthService"], multi: true
                },
...
var UserComponent = /** @class */ (function (_super) {
    ...
    UserComponent.prototype.submit = function () {
        ...
        this.serviceLocator.httpService.post(this.api.save, this.form.data, function (res) {
            ...
            //agr add pr user add ke bad-return Add khulga.
            //  _self.form.data.id=0;
            //Add krne ke -Return-ho kr-Update Khulega.
            _self.form.data.id = res.result.data;
            console.log('FORM', _self.form);
        });
    };
